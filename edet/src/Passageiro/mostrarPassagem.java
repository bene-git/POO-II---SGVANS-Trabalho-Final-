 ...
 */
public class mostrarPassagem extends javax.swing.JFrame {

    /**
     * Creates new form verDatasOleo
     */
    static Cliente conex;
    public mostrarPassagem(Cliente conexao) {
        conex = conexao;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Excluir Tickets");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(mostrarPassagem.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        if(vrf.equals("true")){
            JOptionPane.showMessageDialog(null, "TICKETS EXCLUIDOS");
        } else {
    ...
    public void setarPassagem(String cntTudo){
