...
public class ConfirmaCompra extends javax.swing.JFrame {
    ...
    public ConfirmaCompra(Cliente conexao) {
        conex = conexao;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        assento.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(placa, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(assento, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String passando = "ui"+placa.getText()+"|"+assento.getText()+"|"+saida.getText()+"|"+
                destino.getText()+"|"+valor.getText();
        String vrf = null;
        try {
        ...
        telaInicial ti = new telaInicial(conex);
        if(vrf.equals("false")){
            ...
            JOptionPane.showMessageDialog(null, "COMPRA EFETIVADA\n"
                    + saida.getText()+" - "+destino.getText()+"\n"
                    + "VALOR TICKET = "+valor.getText()+"\n"
                    + "SITUAÇÂO - PAGO");
            ti.setVisible(true);
            ti.setLocationRelativeTo(null);
            dispose();
    ...
    public void setarConfirma(String pl, String asnt, String sd, String dt, String vlr){
        placa.setText(pl);
        assento.setText(asnt);
        saida.setText(sd);
        destino.setText(dt);
        valor.setText(vlr);
    }
