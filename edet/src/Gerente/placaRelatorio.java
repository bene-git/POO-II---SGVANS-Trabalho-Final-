 ...
 */
public class placaRelatorio extends javax.swing.JFrame {

    /**
     * Creates new form placaRelatorio
     */
    static Cliente conex;
    public placaRelatorio(Cliente conexao) {
        conex = conexao;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Relatório Por Carro");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            conex.enviar("pd"+placa);
            vrf = conex.receber();
        } catch (IOException ex) {
            Logger.getLogger(placaRelatorio.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        if(vrf.equals("false")){
            JOptionPane.showMessageDialog(null, "TRANSPORTE ["+placa+"] NÃO EXISTE");
        } else {
            relatorioCarro rc = new relatorioCarro(conex);
            rc.setarVan(vrf);
            rc.setVisible(true);
