 ...
 */
public class placaExcluir extends javax.swing.JFrame {

    /**
     * Creates new form placaExcluir
     */
    static Cliente conex;
    public placaExcluir(Cliente conexao) {
        conex = conexao;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Excluir Transporte");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String vrf = null;
        String passando = "pd"+placa;
        try {
            conex.enviar(passando);
            vrf = conex.receber();
        } catch (IOException ex) {
            Logger.getLogger(placaExcluir.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        if(vrf.equals("false")){
            JOptionPane.showMessageDialog(null, placa+" NOT EXIST");
        } else{
            excluirVan ev = new excluirVan(conex);
            ev.setarExcluir(vrf);
            ev.setVisible(true);
