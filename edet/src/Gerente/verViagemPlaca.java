 ...
 */
public class verViagemPlaca extends javax.swing.JFrame {

    /**
     * Creates new form placaBuscar
     */
    static Cliente conex;
    public verViagemPlaca(Cliente conexao) {
        conex = conexao;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Buscar Viagens");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(vrf.equals("false")){
            ...
            verViagensCarro bvan = new verViagensCarro(conex);
            bvan.setarViagensCarro(vrf);
            bvan.setVisible(true);
            bvan.setLocationRelativeTo(null);
            dispose();
        }
