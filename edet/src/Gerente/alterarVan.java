 ...
 */
public class alterarVan extends javax.swing.JFrame {

    /**
     * Creates new form alterarVan
     */
    static Cliente conex;
    public alterarVan(Cliente conexao) {
        conex = conexao;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alterando Transporte");
        ...
        tipo.setForeground(new java.awt.Color(0, 51, 255));
        tipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "VAN", "MICRO-ONIBUS" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tipoVan = (String) tipo.getSelectedItem();
        String motor = motorista.getText();
        String sen = senha.getText();
        String an = ano.getText();
        String comb = (String) combustivel.getSelectedItem();
        
        String passando = "av"+vet[0].substring(0, vet[0].length()-1)+"|"+placa+"|"+
                motor+"|"+tipoVan+"|"+sen+"|"+an+"|"+comb;
        ...
        try {
            ...
            Logger.getLogger(alterarVan.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if(vrf.equals("false")){
            ...
            JOptionPane.showMessageDialog(null, "TRANSPORTE ["+placa+"] ALTERADO");
            mg.setVisible(true);
            mg.setLocationRelativeTo(null);
            dispose();
        }
    ...
    static String [] vet = new String [11];
    
    public void setarAlterar(String tudo){
        ...
        if(vet[3].substring(0, vet[3].length()-1).equals("VAN")){
        ...
        if((vet[6].substring(0, vet[6].length()-1).equals("DIESEL COMUM"))){
            combustivel.setSelectedIndex(0);
        } else {
            combustivel.setSelectedIndex(1);
        }
    }
