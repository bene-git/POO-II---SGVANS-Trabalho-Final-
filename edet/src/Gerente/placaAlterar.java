 ...
 */
public class placaAlterar extends javax.swing.JFrame {

    /**
     * Creates new form placaAlterar
     */
    static Cliente conex;
    public placaAlterar(Cliente conexao) {
        conex = conexao;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Alterar Transporte");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(placaAlterar.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        if(vrf.equals("false")){
            JOptionPane.showMessageDialog(null, "PLACA NÃO CADASTRADA");
        } else {
            alterarVan avan = new alterarVan(conex);
            avan.setarAlterar(vrf);
