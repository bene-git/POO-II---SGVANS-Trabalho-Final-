 ...
 */
public class placaBuscar extends javax.swing.JFrame {

    /**
     * Creates new form placaBuscar
     */
    static Cliente conex;
    public placaBuscar(Cliente conexao) {
        conex = conexao;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Buscar Transporte");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(vrf.equals("false")){
            ...
            buscarVan bvan = new buscarVan(conex);
            bvan.setarMostrar(vrf);
